...
class AuthController extends Controller
{
            ...
            case 0:
                if (
                    ...
                    if (Auth::user()) {
                        ...
                        if (Auth::user()->onboarding_statu === true) {
                            return redirect()->route('onboarding.check');
                        }
                        if (Auth::user()->is_admin == 1) {
                            return redirect()->route('admin.home');
                        } elseif (Auth::user()->is_admin == 0) {
                            return redirect()->route('user.home');
                        } elseif (Auth::user()->is_admin == 2 && Auth::user()->status == 1) {
    ...
    public function verifyingEmailAccountReset(Request $request)
    {
