                                            ...
                                            <div class="breadcrumbs-simple">
                                                <div class="container">
                                                    <ol class="breadcrumb">
                                                        ...
                                                        <li><span class="active">{{$row->title}}</span></li>
                                                    </ol>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="info-detail-service">
                                            ...
                                            <div class="service-metas-detail d-flex align-items-center flex-wrap">
                                                @foreach($profile as $author)
                                                <div class="service-author">
                                                    <a href="{{url('user/'.$author->identity)}}">
                                                            ...
                                                            <div class="image-wrapper">
                                                                ...
                                                                @if(!empty($author->profile_image))
                                                                    <img decoding="async" width="150" height="150"
                                                                         src="{{asset('profile/photo/'.$author->id.'/'.$author->profile_image)}}"
                                                                         class="attachment-thumbnail size-thumbnail"
                                                                         alt=""
                                                                         srcset="{{asset('profile/photo/'.$author->id.'/'.$author->profile_image)}}"
                                                ...
                                                <div class="rating-reviews">
                                                    ...
                                                    <span class="rating">{{\App\Helpers\CommonHelpers::rating($row->id)}}.0</span>
                                                    <span class="text">({{\App\Models\ServiceRating::query()->where('service_id', $row->id)->count()}} Reviews)</span>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <form id="service-add-to-cart-5549_nxlxK" class="service-add-to-cart" method="post">
                                                        <div class="service-price-inner">
                                                            <span class="woocommerce-Price-amount amount">
                                                                <bdi>
                                                                    ...
                                                                    <span class="price-text">{{$row->price_text}}</span></bdi>
                                                            </span>
                                                        </div>
                                                        ...
                                                        @if(\Illuminate\Support\Facades\Auth::user())
                                                            ...
                                                            @else
                                                                ...
                                                                <a class="btn btn-theme btn-inverse w-100" href="{{url('user/payment/course/'.$row->user_id)}}">Buy Now</a>
                                                ...
                                                <div class="widget-service-author">
                                                    <div class="service-author-heading d-flex align-items-center">
                                                        <div class="service-author-image flex-shrink-0">
                                                            <a href="{{url('/user/'.$profile_->identity)}}">
                                                                <div class="freelancer-logo d-flex align-items-center">
                                                                    <div class="image-wrapper">

                                                                        @if(!empty($profile_->profile_image))
                                                                            <img decoding="async" width="150" height="150"
                                                                                 src="{{asset('profile/photo/'.$profile_->id.'/'.$profile_->profile_image)}}"
                                                                                 class="attachment-thumbnail size-thumbnail"
                                                                                 alt=""
                                                                                 srcset="{{asset('profile/photo/'.$profile_->id.'/'.$profile_->profile_image)}}"
                                                                                 sizes="(max-width: 150px) 100vw, 150px">
                                                                        @else
                                                        ...
                                                        <div class="service-author-right flex-grow-1">
                                                            <h5><a href="{{url('/user/'.$profile_->identity)}}">
                                                                   {{$profile_->full_name}}
                                                                </a>
                                                            </h5>
                                                            <!-- job -->
                                                            <div class="freelancer-job">
                                                               {{$profile_->business_category}}
                                                            </div>
                                                        </div>
                                                    </div>
