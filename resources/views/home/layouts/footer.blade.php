    ...
    <div class="container">
      <div class="row align-items-center justify-content-center justify-content-md-start">
        <div class="col-md-6 col-lg-5 offset-lg-1 text-center text-md-start mt-lg-n5 pt-2 py-md-3 py-lg-0 mb-5 mb-lg-0">
          <h2 class="h1">Find the talent needed to get your business growing.</h2>
          <p class="pb-3">Advertise your jobs to millions of monthly users and search 15.8 million CVs</p>
    ...
    <div class="container pt-sm-2 pt-md-3 pb-md-2">
      ...
      <div class="border-bottom pb-4">
        <div class="d-flex align-items-center justify-content-between pb-2 pb-sm-3">
          <a class="d-inline-flex align-items-center text-dark-emphasis text-decoration-none" href="index.html">
            ...
            <span class="fs-4 fw-semibold">Swiftedge VA</span>
          </a>
      ...
      <div class="d-flex flex-column flex-sm-row align-items-center justify-content-between pb-4 pt-3 pt-sm-2 pt-md-3 pt-lg-4">
        <div class="mb-3 mb-md-0">
          ...
          <a class="text-white text-decoration-none hover-effect-underline me-3" href="#!">Contact us</a>
          <a class="text-white text-decoration-none hover-effect-underline me-3" href="#!">Terms of Service</a>
          <a class="text-white text-decoration-none hover-effect-underline me-3" href="#!">Privacy Policy</a>
          <a class="text-white text-decoration-none hover-effect-underline me-3" href="#!">Site Map</a>
        </div>
        <p class="text-body-secondary fs-sm text-center mb-0">© All rights reserved. Made by <a class="text-body fw-medium text-decoration-none hover-effect-underline" href="https://createx.studio/" target="_blank" rel="noreferrer">SwiftedgeVA</a></p>
      </div>
    </div>
  </footer>
