    ...
    <div class="offcanvas-lg offcanvas-start sticky-lg-top pe-lg-3 pe-xl-4" id="accountSidebar">
      ...
      <div class="offcanvas-header d-lg-block py-3 p-lg-0">
        <div class="d-flex flex-row flex-lg-column align-items-center align-items-lg-start">
          <div class="flex-shrink-0 bg-body-secondary border rounded-circle overflow-hidden" style="width: 64px; height: 64px">
            ...
            @else
            <img src="{{asset('asset/ava.jpg')}}" alt="Avatar"> 
            @endif
          </div>
      ...
      <div class="offcanvas-body d-block pt-2 pt-lg-4 pb-lg-0">
        <nav class="list-group list-group-borderless">
          <a class="list-group-item list-group-item-action d-flex align-items-center {{Request::segment(2)  === "dashboard" ? "active" : ""}}" aria-current="page" href="{{route('user.home')}}">
            <i class="fi-user fs-base opacity-75 me-2"></i>
           Dashboard
          </a>
          <a class="list-group-item list-group-item-action d-flex align-items-center {{Request::segment(2)  === "profile" ? "active" : ""}}" href="{{route('user.profile')}}">
            <i class="fi-layers fs-base opacity-75 me-2"></i>
            View Profile
          </a>
          {{-- <a class="list-group-item list-group-item-action d-flex align-items-center {{Request::segment(2)  === "requests" ? "active" : ""}}" href="{{route('user.service')}}">
            <i class="fi-star fs-base opacity-75 me-2"></i>
            Service
          </a> --}}
          <a class="list-group-item list-group-item-action d-flex align-items-center {{Request::segment(2)  === "jobs" ? "active" : ""}}" href="{{route('user.job')}}">
          ...
          <a class="list-group-item list-group-item-action d-flex align-items-center {{Request::segment(3)  === "change-password" ? "active" : ""}}" href="{{route('user.change.password')}}">
