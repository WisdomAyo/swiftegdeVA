<div class="sidemenu-body">
    <ul class="sidemenu-nav metisMenu h-100" id="sidemenu-nav" data-simplebar>
        ...
        <li class="nav-item {{Request::segment(4)  === "request" ? "active" : ""}}">
            <a href="{{route('admin.user.request')}}" class="nav-link">
                <span class="icon"><i class="ri-file-list-2-fill"></i></span>
                <span class="menu-title">Freelancer Request</span>
            </a>
        </li>

        <li class="nav-item {{Request::segment(4)  === "booking" ? "active" : ""}}">
            <a href="{{route('admin.user.booking')}}" class="nav-link">
                <span class="icon"><i class="ri-file-list-2-fill"></i></span>
                <span class="menu-title">Special Bookings</span>
            </a>
        </li>

<li class="nav-item {{Request::segment(4)  === "skills" ? "active" : ""}}">
            <a href="{{route('admin.getSkills')}}" class="nav-link">
                <span class="icon"><i class="ri-file-list-2-fill"></i></span>
